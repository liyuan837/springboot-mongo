...
public class UserController extends BaseController {
	...
	public ResponseEntity<Integer> queryCount(@RequestBody@Valid UserQueryForm form) throws MongoSpringBootException {
	...
	public ResponseEntity<UserVo> add(@RequestBody@Valid UserCreateForm form) throws MongoSpringBootException {
